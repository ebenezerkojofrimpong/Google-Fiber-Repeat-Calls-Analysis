...
**date_created** => The unique identifier of the movie

**contacts_n** => The unique identifier for individuals involved in the movie

**contacts_n_1** => The title of the movie.

**contacts_n_2** => The year when the movie was released

**contacts_n_3** => The date when the movie was published

**contacts_n_4** => The length of the movie in minutes

**contacts_n_5** => The country where the movie was produced

**contacts_n_6** => The total revenue generated by the movie at the box office

**contacts_n_7** => The primary language in which the movie is produced
